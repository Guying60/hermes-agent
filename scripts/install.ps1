...
$RepoUrlSsh = "git@github.com:Guying60/hermes-agent.git"
$RepoUrlHttps = "https://github.com/Guying60/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Guying60/hermes-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Guying60/hermes-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Guying60/hermes-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }

...
export const en: Translations = {
  ...
  skills: {
    ...
    storeLoadFailed: 'Store failed to load',
    storeEmptyTitle: 'Store is empty',
    storeEmptyDesc: 'No skills published to the store repo yet.',
    install: 'Install',
    installing: 'Installing...',
    installed: 'Installed',
    uninstall: 'Uninstall',
    uninstalling: 'Removing...',
    skillInstalled: name => `Installed ${name}`,
    skillUninstalled: name => `Removed ${name}`,
    skillInstallFailed: name => `Failed to install ${name}`,
    skillUninstallFailed: name => `Failed to remove ${name}`,
    publish: 'Publish',
    publishing: 'Publishing...',
    publishSkill: 'Publish a skill',
    publishPickSkill: 'Publish a skill to the store',
    publishPickPlaceholder: 'Select an installed skill',
    publishNoLocalSkills: 'No local skills available to publish.',
    publishConfirm: name => `Publish ${name} to the store repo?`,
    skillPublished: name => `Published ${name}`,
    skillPublishFailed: name => `Failed to publish ${name}`,
    storeAuthMissingTitle: 'GitHub token required',
    storeAuthMissingDesc: 'Publishing needs a GitHub token with repo write access. Configure GITHUB_TOKEN to continue.',
    storeAuthConfigure: 'Configure token'
  },

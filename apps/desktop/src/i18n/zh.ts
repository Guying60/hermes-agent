...
export const zh: Translations = {
  ...
  skills: {
    ...
    tabStore: '商店',
    searchStore: '搜索商店…',
    storeLoadFailed: '商店加载失败',
    storeEmptyTitle: '商店暂无技能',
    storeEmptyDesc: '该技能仓库尚未发布任何技能。',
    install: '安装',
    installing: '安装中…',
    installed: '已安装',
    uninstall: '卸载',
    ...
    skillUninstalled: name => `已卸载 ${name}`,
    skillInstallFailed: name => `安装 ${name} 失败`,
    skillUninstallFailed: name => `卸载 ${name} 失败`,
    publish: '发布',
    publishing: '发布中…',
    publishSkill: '发布技能',
    publishPickSkill: '发布技能到商店',
    publishPickPlaceholder: '选择一个已安装的技能',
    publishNoLocalSkills: '没有可发布的本地技能。',
    publishConfirm: name => `确认发布 ${name} 到商店仓库？`,
    skillPublished: name => `已发布 ${name}`,
    skillPublishFailed: name => `发布 ${name} 失败`,
    storeAuthMissingTitle: '需要 GitHub 令牌',
    storeAuthMissingDesc: '发布需要具有仓库写权限的 GitHub 令牌。请配置 GITHUB_TOKEN 后继续。',
    storeAuthConfigure: '配置令牌'
  },
